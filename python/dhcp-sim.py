...
def generate_dhcp_seq():
    ...
    hw = "00:00:5e" + str(RandMAC())[8:]#start at 8th index generating numbers out of mac can edit for more random
    hw_str = mac2str(hw)
    #print hw
    
    #Assigning the .command() output of a captured DHCP DISCOVER packet to a variable creating the packets for the info for packets
